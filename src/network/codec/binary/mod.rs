...
pub struct YTransactionBinaryCodec;

impl Decoder for YTransactionBinaryCodec {
...
impl Encoder for YTransactionBinaryCodec {
    type Item = YTransaction;
    type Error = IOError;
...
pub struct YCoinbaseBinaryCodec;

impl Decoder for YCoinbaseBinaryCodec {
    type Item = YCoinbase;
    type Error = IOError;
...
impl Encoder for YCoinbaseBinaryCodec {
    type Item = YCoinbase;
    type Error = IOError;
...
pub struct YPeerBinaryCodec;

impl Decoder for YPeerBinaryCodec {
    type Item = YPeer;
    type Error = IOError;
...
impl Encoder for YPeerBinaryCodec {
    type Item = YPeer;
    type Error = IOError;
